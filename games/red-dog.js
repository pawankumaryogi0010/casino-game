// =====================================================================
// RED-DOG.JS — RedDog (Realtime Multiplayer Stub)
...
(function () {
  const ROOM_NAME = "red-dog-room-1";
  ...
  const choices = [
    { key: "inside", label: "Inside", color: "#FFD700", payout: 2.0 },
    { key: "outside", label: "Outside", color: "#50C878", payout: 2.0 }
  ];
    ...
    container.innerHTML = `
      <div class="w-full">
        ...
        <div class="card-grad rounded-2xl p-6 mb-3 flex items-center justify-center min-h-[160px] relative overflow-hidden shimmer">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none"><path d="M4 4h10v16H4z" stroke="#FFD700" stroke-width="1.5" rx="2"/><path d="M10 6h10v16H10z" stroke="#50C878" stroke-width="1.5" rx="2" opacity="0.6"/></svg>
        </div>
  ...
  window.CasinoGames.redDog = { mount, cleanup };
})();
