// =====================================================================
// HILO.JS — Hilo (Realtime Multiplayer Stub)
...
(function () {
  ...
  const choices = [
    { key: "higher", label: "Higher", color: "#FFD700", payout: 2.0 },
    { key: "lower", label: "Lower", color: "#50C878", payout: 2.0 }
  ];
  ...
  window.CasinoGames.hilo = { mount, cleanup };
})();
