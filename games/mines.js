// =====================================================================
// MINES.JS — Mines (Realtime Multiplayer Stub)
...
(function () {
  ...
  const choices = [
    { key: "safe", label: "Safe", color: "#FFD700", payout: 2.0 },
    { key: "mine", label: "Mine", color: "#50C878", payout: 2.0 }
  ];
  ...
  window.CasinoGames.mines = { mount, cleanup };
})();
