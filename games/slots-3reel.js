// =====================================================================
// SLOTS-3REEL.JS — Slots3Reel (Realtime Multiplayer Stub)
...
(function () {
  const ROOM_NAME = "slots-3reel-room-1";
  ...
  const choices = [
    { key: "spin", label: "Spin", color: "#FFD700", payout: 2.0 }
  ];
    ...
    container.innerHTML = `
      <div class="w-full">
        ...
        <div class="card-grad rounded-2xl p-6 mb-3 flex items-center justify-center min-h-[160px] relative overflow-hidden shimmer">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="18" height="14" rx="2" stroke="#50C878" stroke-width="2"/><path d="M8 5v14M16 5v14" stroke="#50C878" stroke-width="1.5"/></svg>
        </div>
  ...
  window.CasinoGames.slots3reel = { mount, cleanup };
})();
