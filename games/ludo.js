// =====================================================================
// LUDO.JS — Ludo (Realtime Multiplayer Stub)
...
(function () {
  ...
  const choices = [
    { key: "red", label: "Red", color: "#FFD700", payout: 9.0 },
    { key: "blue", label: "Blue", color: "#50C878", payout: 9.0 },
    { key: "yellow", label: "Yellow", color: "#9ca3af", payout: 9.0 },
    { key: "green", label: "Green", color: "#f59e0b", payout: 9.0 }
  ];
    ...
    container.innerHTML = `
      <div class="w-full">
        ...
        <div class="card-grad rounded-2xl p-6 mb-3 flex items-center justify-center min-h-[160px] relative overflow-hidden shimmer">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="2" stroke="#50C878" stroke-width="2"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18" stroke="#50C878" stroke-width="0.75" opacity="0.5"/></svg>
        </div>
  ...
  window.CasinoGames.ludo = { mount, cleanup };
})();
