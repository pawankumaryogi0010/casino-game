// =====================================================================
// VIDEO-POKER.JS — VideoPoker (Realtime Multiplayer Stub)
...
(function () {
  const ROOM_NAME = "video-poker-room-1";
  ...
  const choices = [
    { key: "deal", label: "Deal", color: "#FFD700", payout: 2.0 }
  ];
  ...
  window.CasinoGames.videoPoker = { mount, cleanup };
})();
