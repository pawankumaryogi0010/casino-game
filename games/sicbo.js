// =====================================================================
// SICBO.JS — Sicbo (Realtime Multiplayer Stub)
...
(function () {
  ...
  const choices = [
    { key: "small", label: "Small", color: "#FFD700", payout: 2.0 },
    { key: "big", label: "Big", color: "#50C878", payout: 2.0 },
    { key: "triple", label: "Triple", color: "#9ca3af", payout: 2.0 }
  ];
    ...
    container.innerHTML = `
      <div class="w-full">
        ...
        <div class="card-grad rounded-2xl p-6 mb-3 flex items-center justify-center min-h-[160px] relative overflow-hidden shimmer">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="3" stroke="#50C878" stroke-width="2"/><circle cx="8" cy="8" r="1.5" fill="#50C878"/><circle cx="16" cy="16" r="1.5" fill="#50C878"/><circle cx="12" cy="12" r="1.5" fill="#50C878"/></svg>
        </div>
  ...
  window.CasinoGames.sicbo = { mount, cleanup };
})();
